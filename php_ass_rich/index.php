...
<body>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="select.php">アンケートリスト</a></div>
            </div>
        </nav>
    </header>
    <!-- Head[End] -->
    ...
    <form method="post" action="insert.php">
        <div class="jumbotron">
            <fieldset>
                ...
                <label>年齢：<input type="text" name="age" id=""></label><br>
                <div class="gender">
                ...
                <label>満足度：<input type="text" name="satisfaction" id="">%</label><br>
