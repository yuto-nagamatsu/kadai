...
<body class="bg-gray-200">
    <header>
        ...
        <div class="bg-white p-6 m-6 rounded shadow-md">
            ...
            <!-- <input type="button" value="一覧に戻る" class="mt-4 bg-blue-500 text-white px-6 py-2 rounded cursor-pointer hover:bg-blue-600" href="select_general.php"> -->
            <a class="text-blue-500 text-lg font-bold" href="select_general.php">一覧に戻る</a>
        </div>
